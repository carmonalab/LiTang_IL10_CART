...
il10.umap <- plot.projection(ref=ref, query=il10.sub, linesize = 0.5) + NoLegend() + ggtitle("IL10")
wt.umap <- plot.projection(ref=ref, query=wt.sub, linesize = 0.5) + NoLegend() + ggtitle("WT")
...
ggsave("plots/projected_barplot_norm.pdf",plot=p, width=3,height=4.5)
```
...
ggsave("plots/vlnplots_signature_withreference.pdf", height=12, width=14)
```
