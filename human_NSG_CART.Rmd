...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'human.NSG.html'))})
...
model.Tcells <- models$human$generic$Tcell
...
ggsave("plots/hCART_broad_signatures.IL10.png", height=9, width=15)

FeaturePlot(gex.list$CTRL, features = feats.show, max.cutoff = 'q99')
ggsave("plots/hCART_broad_signatures.CTRL.png", height=9, width=15)
```
...
ggsave("plots/hCART_umap_markers_pureTcells.IL10.png", height=9, width=17)
...
ggsave("plots/hCART_umap_markers_pureTcells.CTRL.png", height=9, width=17)
```
...
ggsave("plots/hCART_umap_signatures_pureTcells.IL10.png", height=3, width=16)
...
ggsave("plots/hCART_umap_signatures_pureTcells.CTRL.png", height=3, width=16)
...
DimPlot(tcells.merged, group.by = "Sample")
```
```{r fig.height=3, fig.width=6}
genes <- c("CD8A","CD4","SELL","IL7R","LEF1","CXCR3","ID3",
           "GZMK", "EOMES","TCF7","FAS","TOX","ID2","GZMA","GZMB","PDCD1","HAVCR2","LAG3","CXCL13","MKI67")
