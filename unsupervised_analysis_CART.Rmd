...
set.seed(123)
data.seurat <- FindNeighbors(data.seurat, reduction = "pca", dims = 1:ndim, k.param = kp,
                             nn.method = "rann")
...
data.seurat$cluster.2[data.serat$hr.cluster=="0_6"] = "Tpex"
data.seurat$cluster.2[data.serat$hr.cluster=="0_8"] = "Tnaive"

data.seurat$cluster.2 <- factor(data.seurat$cluster.2, levels= names(table(data.seurat$cluster.2))) 
Idents(data.serat) <- "cluster.2"
